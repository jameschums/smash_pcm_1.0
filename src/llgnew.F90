!
!     routine to generate the lebedev-laikov grid (g and w for the weights arrays)
!     with the closest number of points from ng
!
...
!
!     scaling because the weights are normalised and back to grid format
!
      pi = four*atan(one)
      do 20 i = 1, ngrid
        w(i) = wtemp(i)*four*pi
...
!      describing their codes.
!   
!      This code was distributed through CCL (http://wtempwtempwtemp.ccl.net/).
!   
!      [1] V.I. Lebedev, and D.N. Laikov
!          "A quadrature formula for the sphere of the 131st
!           algebraic order of accuracy"
